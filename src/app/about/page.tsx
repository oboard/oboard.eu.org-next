...
export default function About() {
  return (
    <article className={"text-base prose py-12 px-4"}>
      <h2>🎨 关于本站</h2>
      <p>
      ...
      <ul>
        <li>
          Email - <Link href="mailto:oboard@outlook.com">oboard@outlook.com</Link>
        </li>
        <li>
          Github - <Link href="https://github.com/oboard">https://github.com/oboard</Link>
        </li>
      </ul>
    </article>
  )
